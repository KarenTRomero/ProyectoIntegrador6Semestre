<%-- 
    Document   : Vista_Divi
    Created on : 20/11/2020, 01:20:21 PM
    Author     : LAURA
--%>
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">
                                        ...
                                        <a type="submit" name="btn_Limpiar" id="limpiar" href="Eliminar_Divi.jsp" onclick="return confirm('Estás seguro que deseas eliminar toda la informacion?');">Limpiar <i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </th>
