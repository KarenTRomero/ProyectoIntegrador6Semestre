<%-- 
    Document   : Vista_Sugerencia
    Created on : 19/11/2020, 11:19:00 PM
    Author     : LAURA
--%>
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">
                                        ...
                                        <a type="submit" name="btn_Limpiar" id="limpiar" href="Eliminar_Sumas.jsp" onclick="return confirm('Estás seguro que deseas eliminar toda la informacion?');"> Limpiar <i class="fa fa-trash" aria-hidden="true"></i></a>
